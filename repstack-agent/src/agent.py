...
10. **루틴 관련 중요 규칙**: 사용자가 루틴/운동 프로그램을 요청하면 반드시 generate_routine 또는 get_today_routine 도구를 사용하세요.
    절대로 텍스트 메시지에 운동 목록(세트, 회, 운동명 등)을 직접 작성하지 마세요.
    도구를 통해 생성된 루틴만 iOS 앱에서 카드 형태로 표시됩니다."""
