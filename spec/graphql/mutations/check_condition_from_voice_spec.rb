...
RSpec.describe Mutations::CheckConditionFromVoice, type: :graphql do
  ...
  # Mock AiTrainer::ConditionService responses
  ...
  describe "when authenticated" do
    context "with Korean voice input" do
      it "analyzes tired condition" do
        allow(AiTrainer::ConditionService).to receive(:analyze_from_voice).and_return(tired_condition_response)
      ...
      it "analyzes good condition" do
        allow(AiTrainer::ConditionService).to receive(:analyze_from_voice).and_return(good_condition_response)
      ...
      it "analyzes soreness and modifies exercises" do
        allow(AiTrainer::ConditionService).to receive(:analyze_from_voice).and_return(soreness_condition_response)
