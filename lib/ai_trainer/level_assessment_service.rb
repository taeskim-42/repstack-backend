  ...
  class LevelAssessmentService
    ...
    def build_conversation(user_message, current_state)
      ...
      system_prompt = <<~PROMPT
        ...
        - 예: 초보자 + 다이어트 → "처음이시니까 8주 정도로 시작해보는 건 어떨까요?"
        - 예: 중급자 + 근비대 → "경험이 있으시니 12주 주기화 프로그램을 추천드려요!"
        - 반드시 "알아서 해줘" (AI가 최적 기간 결정) 옵션도 suggestions에 포함하세요
        - 사용자가 "알아서 해줘"를 선택하면 program_duration에 "AI 추천"이라고 저장하세요
